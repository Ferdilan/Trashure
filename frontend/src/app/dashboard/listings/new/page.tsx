...
export default function CreateListingPage() {
  ...
  const [locationName, setLocationName] = useState('Jalan Jend. Sudirman No. 1, Jakarta (Sesuai profil Anda)');
  ...
  const useProfileLocation = () => {
    setLatitude(null);
    setLongitude(null);
    setLocationName('Jalan Jend. Sudirman No. 1, Jakarta (Sesuai profil Anda)');
    setLocationMethod('profile');
  };
